...
### 🍷 Wine classifier | Clasificador de vinos
...
| `Python` `KNN` `Streamlit` `EDA` | 🌐 [Live demo / Demo en vivo](https://app-web-de-ml-usando-streamlit-1.onrender.com/) |

---

### 🩺 Diabetes predictor · DiabetesScan | Predictor de diabetes · DiabetesScan
...
| `Python` `Random Forest` `Flask` `Binary classification` | 🌐 [Live demo / Demo en vivo](https://app-web-de-ml-usando-flask.onrender.com/) |

---

### 🎙️ Streaming platforms subtitling | Subtitulado para plataformas de streaming
...
| `Subtitling` `Proofreading` `Localization` `EN ↔ ES Translation` | [TED portfolio](https://www.ted.com/profiles/translator) |
